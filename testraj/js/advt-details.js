...
$(function(){ 
	var localAherbook = {
		init: function () {
			...
			if(queryString != ""){
				localAherbook.getAdvt_by_id(queryString);
			}
			this.selectUser();
			localAherbook.getuserdetails();
       ...
       error: function (xhr, ajaxOptions, thrownError) {
	    ...
	    DropAllTable: function() {
			...
			AHERBOOK.transaction(
			    function (transaction) {
					transaction.executeSql("DROP TABLE users;DROP TABLE user_book;DROP TABLE user_book_records;DROP TABLE vendor_advt;", [], that.nullDataHandler, that.errorHandler);
			    	}
			);
